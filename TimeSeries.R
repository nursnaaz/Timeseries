...
#Holt-Winters with ETS() model with defaults
milesHW3 <- ets(milestimeseries)
summary(milesHW3)

milesresidualsHW3 <- residuals(milesHW3)
milesresidualsHW3
plot(milesresidualsHW3)
par(mfrow = c(1,2))
acf(milesresidualsHW3)
pacf(milesresidualsHW3)

milesforecastHW3 <- 
  forecast(milesHW3,h=36)
milesforecastHW3

plot.forecast(milesforecastHW3,
              shadecols="oldstyle")

#Holt-Winters with hw() function of
#Prof. Hyndman's "forecast" package
milesHW4 <- hw(milestimeseries)
summary(milesHW4)

milesresidualsHW4 <- residuals(milesHW4)
milesresidualsHW4
par(mfrow = c(1,1))
plot(milesresidualsHW4)
par(mfrow = c(1,2))
acf(milesresidualsHW4)
pacf(milesresidualsHW4)

milesforecastHW4 <- 
  forecast(milesHW4)
milesforecastHW4

plot.forecast(milesforecastHW4,
              shadecols="oldstyle")
